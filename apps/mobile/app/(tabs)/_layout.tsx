...
export default function TabLayout() {
  ...
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarStyle: { backgroundColor: colors.surface, borderTopColor: colors.border, borderTopWidth: 0.5, height: 82, paddingBottom: 22, paddingTop: 10 }, tabBarActiveTintColor: colors.indigoGlow, tabBarInactiveTintColor: colors.dim, tabBarLabelStyle: { fontSize: 10, fontWeight: '600', marginTop: 2 } }}>
